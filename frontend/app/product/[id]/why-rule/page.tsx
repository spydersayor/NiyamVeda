  ...
  return (
    <div className="flex min-h-screen portal-bg font-sans text-slate-800">
      ...
      <div className="flex-1 ml-14 py-8 px-4 sm:px-8 flex items-center justify-center">
        <div className="max-w-2xl w-full bg-white/95 backdrop-blur-md rounded-xl shadow-2xl border border-white/60 p-6 sm:p-8 relative space-y-6 animate-slide-up">
